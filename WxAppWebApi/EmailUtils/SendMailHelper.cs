...
using static WxAppWebApi.EmailUtils.MailBodyEntity;
using System.Security.Authentication;

namespace WxAppWebApi.EmailUtils
{
    /// <summary>
    /// 发送邮件
    /// </summary>
    public class SendMailHelper
    {
        ...
        public static async Task<SendResultEntity> SendMail(MailBodyEntity mailBodyEntity)
        {
            ...
            //    throw new ArgumentNullException();
            //}
            sendServerConfiguration.SmtpPort = 25;
            sendServerConfiguration.SmtpHost = "smtp.qq.com";
            sendServerConfiguration.SenderAccount = "1220534572@qq.com";
            sendServerConfiguration.SenderPassword = "cohfsfnsiwjugiej";
            sendServerConfiguration.MailEncoding = "utf-8";
            sendServerConfiguration.IsSsl = false;
            mailBodyEntity.Sender = "王瑞峰";
            mailBodyEntity.SenderAddress = "1220534572@qq.com";
